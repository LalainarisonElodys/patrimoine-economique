    ...
    return (
        <div className='m-3'>
            ...
            <div>
                ...
                <button className='btn btn-success m-3 mb-5' onClick={handleGetValeurPatrimoine}>Valider</button>
            ...
            <button className='btn btn-success m-2' onClick={handleGetValeurPatrimoineRange}>Valider Plage</button>
